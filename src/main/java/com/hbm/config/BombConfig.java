...
public class BombConfig {
	...
	public static void loadFromConfig(Configuration config) {
		...
		propFalloutRange.setComment("Minimum amount of milliseconds per tick allocated for mk5 chunk processing");
		...
		falloutDelayProp.setComment("How many ticks to wait for the next fallout chunk computation");
