...
public class GeneralConfig {
	...
	public static String[] preferredOutputMod = new String[] {"hbm"};
	...
	public static void loadFromConfig(Configuration config) {
		...
		preferredOutputMod = CommonConfig.createConfigStringList(config,CATEGORY_GENERAL,"1.42_preferredOutputMod",
				"The mod which is preferred as output when certain machines autogenerate recipes. Currently used for the shredder", new String[] {"hbm"});
